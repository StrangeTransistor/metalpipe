(function ()
{
		...
		(function (Hogan)
		{
			...
			Hogan.scan = function scan (text, delimiters)
			{
				...
				for (i = 0; i < len; i++)
				{
					...
					{
						tokens.push({ tag: tagType, n: trim(buf), otag, ctag,
	...
	(function (exports)
	{
		...
		(function (Hogan)
		{
			...
			Hogan.Template.prototype = {
				...
				fl () { var r = this.buf; this.buf = ''; return r },
	...
	var mst = new hogan.Template({ code (c, p, i) { var t = this;t.b(i = i || '');t.b(t.v(t.f('data', c, p, 0)));return t.fl() }, partials: {}, subs: {  }})
	...
	{
		var classString = ''; var className; var padding = ''; var
	...
	{
		var pug_html = ''
		var pug_interp;var pug_debug_filename; var
			pug_debug_line;try
		{
		...
		catch (err) { pugRuntime.rethrow(err, pug_debug_filename, pug_debug_line, pug_debug_sources[pug_debug_filename]) } return pug_html
	}
